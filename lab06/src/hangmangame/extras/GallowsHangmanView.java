...
public class GallowsHangmanView extends JPanel implements IHangmanView {
  ...
  public GallowsHangmanView(Hangman hangman) {
    ...
    bodyLines[0] = new Line2D.Double(head.getX() + (head.getWidth() / 2), head.getY() + head.getHeight(), head.getX() + (head.getWidth() / 2), head.getY() + head.getHeight() + 70);
    //left leg
    bodyLines[1] = new Line2D.Double(bodyLines[0].getX2(), bodyLines[0].getY2(), bodyLines[0].getX2() - 30, bodyLines[0].getY2() + 60);
    //right leg
    bodyLines[2] = new Line2D.Double(bodyLines[0].getX2(), bodyLines[0].getY2(), bodyLines[0].getX2() + 30, bodyLines[1].getY2()); 
    //left arm
    bodyLines[3] = new Line2D.Double(bodyLines[0].getX2(), ((bodyLines[0].getY2() - bodyLines[0].getY1()) / 5) + bodyLines[0].getY1(), bodyLines[0].getX1() - 28, ((bodyLines[0].getY2() - bodyLines[0].getY1()) / 4) + bodyLines[0].getY1() + 40);
    //right arm
    bodyLines[4] = new Line2D.Double(bodyLines[0].getX2(), bodyLines[3].getY1(), bodyLines[0].getX1() + 28, bodyLines[3].getY2());
